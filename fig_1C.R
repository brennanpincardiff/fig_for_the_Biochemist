# figure 1C
# https://rforbiochemists.blogspot.com/2017/01/playing-with-phylogenetic-tree.html
...
# 1. Open jpeg file
png("fig_1C.png", width = 15, height = 15, 
    units = "cm", res = 300)
...
# image comments: margin too large. crop in Adobe... 
