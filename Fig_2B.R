...
p <- ggplot(data=data,          # specify the data frame with data
    ...
    scale_x_log10(labels = scales::comma, breaks = c(500, 1000, 2500, 5000, 10000, 20000))+
    labs(x = "Drug concentration (nM)", # label x-axis
         y = "Dead cells (% of cells)", # label y-axis
         title = "Drug Dose-response \n and LD50 calc",
         subtitle = paste("LD50(nM):", val)) +
